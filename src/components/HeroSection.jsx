  ...
  return (
    <div className='bg-thirdColor flex justify-center items-center h-[85vh]'>
      <div className='flex flex-col ms-[10%] me-[10%]'>
        ...
        <a href="#" className=' text-primaryColor p-2 rounded-lg inline-block mt-7 text-center font-bold bg-gradient-to-r from-secondaryColor to-white hover:text-secondaryColor hover:bg-gradient-to-r hover:from-primaryColor hover:to-white transition duration-500'>See My Work</a>
      </div>
    </div>
  )
}
